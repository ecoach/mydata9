...
STATIC_ROOT = DIR_PROJ + 'staticroot/' + CPROJ_NAME 
...
AUTH_PROFILE_MODULE = CPROJ_NAME + '.UserProfile'

AUTHENTICATION_BACKENDS = (
    CPROJ_NAME + '.backends.SettingsBackend',
)

LOGIN_URL = '/' + MPROJ_NAME + '/login/'

LOGIN_REDIRECT_URL = '/' + MPROJ_NAME + '/'

TAILORING2_PROJECT_ROOT = DIR_PROJ + DPROJ_NAME + '/' + MPROJ_NAME + '/'
MYCOACH_PROJECT_ROOT = DIR_PROJ + CPROJ_NAME + '/'

#TAILORING2_PROJECT_CONFIG = DIR_PROJ + "tailoring2/tailoring2/config.py"
#or
